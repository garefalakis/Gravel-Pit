...
""" Same as above, but just to calculate the normalised CI length (CI_lengt / percentile) and the increasing counts (no minicounts --> takes time!) """


def increasing_CI_BT_multipledata_nomincounts(grainsizedata_multi, percentile, confidenceinterval, iterations):
    ...
    return(norm_length_CI_all, increasing_counts_all)
    # return(norm_length_CI_all, increasing_counts_all, mincounts_all, data_perc_all)
