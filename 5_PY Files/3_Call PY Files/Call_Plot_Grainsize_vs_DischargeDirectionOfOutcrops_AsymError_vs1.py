...
def subplot_photo_data_vs_discharge_direction(data1, data2, data1_SD, data2_SD,
    ...
    site_label = ['Site A vs B ($LVA$)', 'Site A vs B ($SVA$)', 'Site C vs D ($LVA$)', 'Site C vs D ($SVA$)']
    ...
    axs[setnumber].set_ylabel(ylabel='Site A ($LVA$) (mm)', fontsize=fontsz2, **hfont)
    axs[setnumber].set_xlabel(xlabel='Site B ($LVA$) (mm)', fontsize=fontsz2, **hfont)
    
    # axs[setnumber].set_ylabel(ylabel='Set A ($LVA$' + ' \u2248' + ' $a-axis$)', fontsize=fontsz2, **hfont)
    # axs[setnumber].set_xlabel(xlabel='Set B ($LVA$' + ' \u2248' + ' $b-axis$)', fontsize=fontsz2, **hfont)
    ...
    ### Plot original data (i.e. percentiles) with errorbar:
        axs[setnumber].errorbar(data2[i], data1[i],
                                ...
                                color=colors_LVA[i], fmt=style_dot[i], label=dot_label[i])
        
        ### Calculate lins concordance correlation coefficient:
        lins_ccc_value = lins_ccc(data2[i], data1[i])
        ccc_val_setAB_LVA.append(lins_ccc_value)
    ...
    axs[setnumber].set_ylabel(ylabel='Site A ($SVA$) (mm)', fontsize=fontsz2, **hfont)
    axs[setnumber].set_xlabel(xlabel='Site B ($SVA$) (mm)', fontsize=fontsz2, **hfont)
    
    # axs[setnumber].set_ylabel(ylabel='Set A ($SVA$' + ' \u2248' + ' $c-axis$)', fontsize=fontsz2, **hfont)
    # axs[setnumber].set_xlabel(xlabel='Set B ($SVA$' + ' \u2248' + ' $c-axis$)', fontsize=fontsz2, **hfont)
    ...
    ### Plot original data (i.e. percentiles) with errorbar:
        ...
        ### Calculate lins concordance correlation coefficient:
        lins_ccc_value = lins_ccc(data4[i], data3[i])
        ccc_val_setAB_SVA.append(lins_ccc_value)
    ...
    axs[setnumber].set_ylabel(ylabel='Site C ($LVA$) (mm)', fontsize=fontsz2, **hfont)
    axs[setnumber].set_xlabel(xlabel='Site D ($LVA$) (mm)', fontsize=fontsz2, **hfont)
    
    # axs[setnumber].set_ylabel(ylabel='Set C ($LVA$' + ' \u2248' + ' $a-axis$)', fontsize=fontsz2, **hfont)
    # axs[setnumber].set_xlabel(xlabel='Set D ($LVA$' + ' \u2248' + ' $b-axis$)', fontsize=fontsz2, **hfont)
    ...
    ### Plot original data (i.e. percentiles) with errorbar:
        ...
        ### Calculate lins concordance correlation coefficient:
        lins_ccc_value = lins_ccc(data6[i], data5[i])
        ccc_val_setCD_LVA.append(lins_ccc_value)
    ...
    axs[setnumber].set_ylabel(ylabel='Site C ($SVA$) (mm)', fontsize=fontsz2, **hfont)
    axs[setnumber].set_xlabel(xlabel='Site D ($SVA$) (mm)', fontsize=fontsz2, **hfont)
    
    # axs[setnumber].set_ylabel(ylabel='Set C ($SVA$' + ' \u2248' + ' $c-axis$)', fontsize=fontsz2, **hfont)
    # axs[setnumber].set_xlabel(xlabel='Set D ($SVA$' + ' \u2248' + ' $c-axis$)', fontsize=fontsz2, **hfont)
    ...
    onerpercent = plotlim/100
    # x_oneline, y_oneline = (plotlim - 10*onerpercent, plotlim - 8*onerpercent)  
    x_oneline, y_oneline = (plotlim - 14*onerpercent, plotlim - 1*onerpercent)  
    axs[setnumber].text(x_oneline, y_oneline, "1-1", rotation=45, size=4.5, alpha=0.75, ha='left', va='top')
    ...
    ### Plot original data (i.e. percentiles) with errorbar:
        ...
        ### Calculate lins concordance correlation coefficient:
        lins_ccc_value = lins_ccc(data8[i], data7[i])
        ccc_val_setCD_SVA.append(lins_ccc_value)
    ...
    ccc_vals = [ccc_val_setAB_LVA, ccc_val_setAB_SVA, ccc_val_setCD_LVA, ccc_val_setCD_SVA]
    ...
    plt.savefig('Fig_' + plotname + '_NEW.png', dpi=600, bbox_inches='tight') ### , bbox_inches='tight'
    plt.show()
...
CCC_set_comparison = subplot_photo_data_vs_discharge_direction(setA_LVA_perc, setB_LVA_perc, setA_LVA_perc_CI, setB_LVA_perc_CI,
...
avg_set_AB_LVA = np.average(CCC_set_comparison[0])

avg_set_AB_SVA = np.average(CCC_set_comparison[1])

avg_set_CD_LVA = np.average(CCC_set_comparison[2])

avg_set_CD_SVA = np.average(CCC_set_comparison[3])
