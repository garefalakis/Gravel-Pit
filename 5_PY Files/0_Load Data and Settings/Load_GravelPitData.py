...
# [largest_grains_LVA_GAD, grains_bigger_LVA_GAD, index_values_bigger_LVA_GAD, LVA_GAD_valuesbigger_Xmm, grains_removed_bigger_LVA_GAD] = largest_grains(photo_1_8_LVA_dist_grid, 125.0)
# set_A_LVA_GAD_NoRocks = np.append(grains_removed_bigger_LVA_GAD[0], grains_removed_bigger_LVA_GAD[1])
# set_A_LVA_GAD_KeyPerc = np.percentile(set_A_LVA_GAD_NoRocks, [16,50,84])
...
GAD_LVA_AVG_setABCD = [np.average(photo_12_LVA_dist_grid), np.average(photo_34_LVA_dist_grid), np.average(photo_56_LVA_dist_grid), np.average(photo_78_LVA_dist_grid)]
GAD_SVA_AVG_setABCD = [np.average(photo_12_SVA_dist_grid), np.average(photo_34_SVA_dist_grid), np.average(photo_56_SVA_dist_grid), np.average(photo_78_SVA_dist_grid)]
...
# [largest_grains_LVA_GAU, grains_bigger_LVA_GAU, index_values_bigger_LVA_GAU, LVA_GAU_valuesbigger_Xmm, grains_removed_bigger_LVA_GAU] = largest_grains(photo_1_8_LVA_UNdist_grid, 125.0)
# set_A_LVA_GAU_NoRocks = np.append(grains_removed_bigger_LVA_GAU[0], grains_removed_bigger_LVA_GAU[1])
# set_A_LVA_GAU_KeyPerc = np.percentile(set_A_LVA_GAU_NoRocks, [16,50,84])

# ### Remove same grains tha have LVA > 125mm from SVA dataset
# set_A_SVA_GAU_NoRocks_Raw = remove_data_by_index(photo_1_8_SVA_UNdist_grid, index_values_bigger_LVA_GAU)
# set_A_SVA_GAU_NoRocks = np.append(set_A_SVA_GAU_NoRocks_Raw[0], set_A_SVA_GAU_NoRocks_Raw[1])
# set_A_SVA_GAU_KeyPerc = np.percentile(set_A_SVA_GAU_NoRocks, [16,50,84])

### ---> ATTENTION, I also have to remove the FINES, after removing the large rocks from the data!
### or just manually remove the largest rock and quickly compare the Percentile Values!
...
GAU_LVA_AVG_setABCD = [np.average(photo_12_LVA_UNdist_grid), np.average(photo_34_LVA_UNdist_grid), np.average(photo_56_LVA_UNdist_grid), np.average(photo_78_LVA_UNdist_grid)]
GAU_SVA_AVG_setABCD = [np.average(photo_12_SVA_UNdist_grid), np.average(photo_34_SVA_UNdist_grid), np.average(photo_56_SVA_UNdist_grid), np.average(photo_78_SVA_UNdist_grid)]
...
RAD_LVA_AVG_setABCD = [np.average(photo_12_LVA_dist_RND), np.average(photo_34_LVA_dist_RND), np.average(photo_56_LVA_dist_RND), np.average(photo_78_LVA_dist_RND)]
RAD_SVA_AVG_setABCD = [np.average(photo_12_SVA_dist_RND), np.average(photo_34_SVA_dist_RND), np.average(photo_56_SVA_dist_RND), np.average(photo_78_SVA_dist_RND)]
...
RAU_LVA_AVG_setABCD = [np.average(photo_12_LVA_UNdist_RND), np.average(photo_34_LVA_UNdist_RND), np.average(photo_56_LVA_UNdist_RND), np.average(photo_78_LVA_UNdist_RND)]
RAU_SVA_AVG_setABCD = [np.average(photo_12_SVA_UNdist_RND), np.average(photo_34_SVA_UNdist_RND), np.average(photo_56_SVA_UNdist_RND), np.average(photo_78_SVA_UNdist_RND)]
...
# hand_1_A_cleared = grains_removed_biggerA[0]
# hand_2_A_cleared = grains_removed_biggerA[1]
# hand_3_A_cleared = grains_removed_biggerA[2]
# hand_4_A_cleared = grains_removed_biggerA[3]
# hand_5_A_cleared = grains_removed_biggerA[4]
# hand_6_A_cleared = grains_removed_biggerA[5]
# hand_7_A_cleared = grains_removed_biggerA[6]
# hand_8_A_cleared = grains_removed_biggerA[7]


# [largest_grainsB, grains_biggerB, index_values_biggerB, hand_B_valuesbigger_Xmm, grains_removed_biggerB] = largest_grains(hand_all_B_axes, 125.0)

# hand_1_B_biggermm = hand_B_valuesbigger_Xmm[0]
# hand_2_B_biggermm = hand_B_valuesbigger_Xmm[1]
# hand_3_B_biggermm = hand_B_valuesbigger_Xmm[2]
# hand_4_B_biggermm = hand_B_valuesbigger_Xmm[3]
# hand_5_B_biggermm = hand_B_valuesbigger_Xmm[4]
# hand_6_B_biggermm = hand_B_valuesbigger_Xmm[5]
# hand_7_B_biggermm = hand_B_valuesbigger_Xmm[6]
# hand_8_B_biggermm = hand_B_valuesbigger_Xmm[7]


# hand_1_B_cleared = grains_removed_biggerB[0]
# hand_2_B_cleared = grains_removed_biggerB[1]
# hand_3_B_cleared = grains_removed_biggerB[2]
# hand_4_B_cleared = grains_removed_biggerB[3]
# hand_5_B_cleared = grains_removed_biggerB[4]
# hand_6_B_cleared = grains_removed_biggerB[5]
# hand_7_B_cleared = grains_removed_biggerB[6]
# hand_8_B_cleared = grains_removed_biggerB[7]


# [largest_grainsC, grains_biggerC, index_values_biggerC, hand_C_valuesbigger_Xmm, grains_removed_biggerC] = largest_grains(hand_all_C_axes, 125.0)

# hand_1_C_biggermm = hand_C_valuesbigger_Xmm[0]
# hand_2_C_biggermm = hand_C_valuesbigger_Xmm[1]
# hand_3_C_biggermm = hand_C_valuesbigger_Xmm[2]
# hand_4_C_biggermm = hand_C_valuesbigger_Xmm[3]
# hand_5_C_biggermm = hand_C_valuesbigger_Xmm[4]
# hand_6_C_biggermm = hand_C_valuesbigger_Xmm[5]
# hand_7_C_biggermm = hand_C_valuesbigger_Xmm[6]
# hand_8_C_biggermm = hand_C_valuesbigger_Xmm[7]


# hand_1_C_cleared = grains_removed_biggerC[0]
# hand_2_C_cleared = grains_removed_biggerC[1]
# hand_3_C_cleared = grains_removed_biggerC[2]
# hand_4_C_cleared = grains_removed_biggerC[3]
# hand_5_C_cleared = grains_removed_biggerC[4]
# hand_6_C_cleared = grains_removed_biggerC[5]
# hand_7_C_cleared = grains_removed_biggerC[6]
# hand_8_C_cleared = grains_removed_biggerC[7]



# print("-----------------------------------------")
# print("GRAINS >125 mm have been REMOVED from the HAND DATA !! ")
...
### data in respect to the hand b-axis. --> See Call_Plot_Grainshape_AxesRatios_vs1.py
...
# setA_Dsb_corr_factor = 0.8464767695712473
# setB_Dsb_corr_factor = 0.8670242453392554
# setC_Dsb_corr_factor = 0.8533836002249648
# setD_Dsb_corr_factor = 0.8523924005875569

# sieve_A_perc_lin = np.divide(sieve_A_perc_lin, setA_Dsb_corr_factor)
# sieve_B_perc_lin = np.divide(sieve_B_perc_lin, setB_Dsb_corr_factor)
# sieve_C_perc_lin = np.divide(sieve_C_perc_lin, setC_Dsb_corr_factor)
# sieve_D_perc_lin = np.divide(sieve_D_perc_lin, setD_Dsb_corr_factor)
...
############ CALCULATION OF AVERAGE CORRECTION FACTOR ###############

""" GAD LVA """

set_A_GAD_LVA_a = np.average(photo_12_LVA_dist_grid) / np.average(hand_12_A)
set_B_GAD_LVA_a = np.average(photo_34_LVA_dist_grid) / np.average(hand_34_A)
set_C_GAD_LVA_a = np.average(photo_56_LVA_dist_grid) / np.average(hand_56_A)
set_D_GAD_LVA_a = np.average(photo_78_LVA_dist_grid) / np.average(hand_78_A)

set_ABCD_GAD_LVA_a_avg = np.average([set_A_GAD_LVA_a, set_B_GAD_LVA_a, set_C_GAD_LVA_a, set_D_GAD_LVA_a])

### TRUNCATED DATA, average rounded values: set A = 0.85, B = 0.82, C = 0.79, D = 0.92
# set_ABCD_GAD_LVA_b_avg =  0.846609609005291 (TRUNCATED DATA) or 0.8437867328474353 (ORIGINAL DATA)


set_A_GAD_LVA_b = np.average(photo_12_LVA_dist_grid) / np.average(hand_12_B)
set_B_GAD_LVA_b = np.average(photo_34_LVA_dist_grid) / np.average(hand_34_B)
set_C_GAD_LVA_b = np.average(photo_56_LVA_dist_grid) / np.average(hand_56_B)
set_D_GAD_LVA_b = np.average(photo_78_LVA_dist_grid) / np.average(hand_78_B)

set_ABCD_GAD_LVA_b_avg = np.average([set_A_GAD_LVA_b, set_B_GAD_LVA_b, set_C_GAD_LVA_b, set_D_GAD_LVA_b])

### TRUNCATED DATA, average rounded values: set A = 0.85, B = 0.82, C = 0.79, D = 0.92
# set_ABCD_GAD_LVA_b_avg =  0.846609609005291 (TRUNCATED DATA) or 0.8437867328474353 (ORIGINAL DATA)


set_A_GAD_LVA_c = np.average(photo_12_LVA_dist_grid) / np.average(hand_12_C)
set_B_GAD_LVA_c = np.average(photo_34_LVA_dist_grid) / np.average(hand_34_C)
set_C_GAD_LVA_c = np.average(photo_56_LVA_dist_grid) / np.average(hand_56_C)
set_D_GAD_LVA_c = np.average(photo_78_LVA_dist_grid) / np.average(hand_78_C)

set_ABCD_GAD_LVA_c_avg = np.average([set_A_GAD_LVA_c, set_B_GAD_LVA_c, set_C_GAD_LVA_c, set_D_GAD_LVA_c])
### Truncated Data, set A = 1.35, B = 1.19, C = 1.21, D = 1.43
# set_ABCD_GAD_LVA_c_avg = 1.2939064477638667 (TRUNCATED DATA)


""" GAD SVA """

set_A_GAD_SVA_a = np.average(photo_12_SVA_dist_grid) / np.average(hand_12_A)
set_B_GAD_SVA_a = np.average(photo_34_SVA_dist_grid) / np.average(hand_34_A)
set_C_GAD_SVA_a = np.average(photo_56_SVA_dist_grid) / np.average(hand_56_A)
set_D_GAD_SVA_a = np.average(photo_78_SVA_dist_grid) / np.average(hand_78_A)

set_ABCD_GAD_SVA_a_avg = np.average([set_A_GAD_SVA_a, set_B_GAD_SVA_a, set_C_GAD_SVA_a, set_D_GAD_SVA_a])


set_A_GAD_SVA_b = np.average(photo_12_SVA_dist_grid) / np.average(hand_12_B)
set_B_GAD_SVA_b = np.average(photo_34_SVA_dist_grid) / np.average(hand_34_B)
set_C_GAD_SVA_b = np.average(photo_56_SVA_dist_grid) / np.average(hand_56_B)
set_D_GAD_SVA_b = np.average(photo_78_SVA_dist_grid) / np.average(hand_78_B)

set_ABCD_GAD_SVA_b_avg = np.average([set_A_GAD_SVA_b, set_B_GAD_SVA_b, set_C_GAD_SVA_b, set_D_GAD_SVA_b])


set_A_GAD_SVA_c = np.average(photo_12_SVA_dist_grid) / np.average(hand_12_C)
set_B_GAD_SVA_c = np.average(photo_34_SVA_dist_grid) / np.average(hand_34_C)
set_C_GAD_SVA_c = np.average(photo_56_SVA_dist_grid) / np.average(hand_56_C)
set_D_GAD_SVA_c = np.average(photo_78_SVA_dist_grid) / np.average(hand_78_C)

set_ABCD_GAD_SVA_c_avg = np.average([set_A_GAD_SVA_c, set_B_GAD_SVA_c, set_C_GAD_SVA_c, set_D_GAD_SVA_c])
...
set_A_GAU_LVA_a = np.average(photo_12_LVA_UNdist_grid) / np.average(hand_12_A)
set_B_GAU_LVA_a = np.average(photo_34_LVA_UNdist_grid) / np.average(hand_34_A)
set_C_GAU_LVA_a = np.average(photo_56_LVA_UNdist_grid) / np.average(hand_56_A)
set_D_GAU_LVA_a = np.average(photo_78_LVA_UNdist_grid) / np.average(hand_78_A)

set_ABCD_GAU_LVA_a_avg = np.average([set_A_GAU_LVA_a, set_B_GAU_LVA_a, set_C_GAU_LVA_a, set_D_GAU_LVA_a])

set_A_GAU_LVA_b = np.average(photo_12_LVA_UNdist_grid) / np.average(hand_12_B)
set_B_GAU_LVA_b = np.average(photo_34_LVA_UNdist_grid) / np.average(hand_34_B)
set_C_GAU_LVA_b = np.average(photo_56_LVA_UNdist_grid) / np.average(hand_56_B)
set_D_GAU_LVA_b = np.average(photo_78_LVA_UNdist_grid) / np.average(hand_78_B)

set_ABCD_GAU_LVA_b_avg = np.average([set_A_GAU_LVA_b, set_B_GAU_LVA_b, set_C_GAU_LVA_b, set_D_GAU_LVA_b])


set_A_GAU_LVA_c = np.average(photo_12_LVA_UNdist_grid) / np.average(hand_12_C)
set_B_GAU_LVA_c = np.average(photo_34_LVA_UNdist_grid) / np.average(hand_34_C)
set_C_GAU_LVA_c = np.average(photo_56_LVA_UNdist_grid) / np.average(hand_56_C)
set_D_GAU_LVA_c = np.average(photo_78_LVA_UNdist_grid) / np.average(hand_78_C)

set_ABCD_GAU_LVA_c_avg = np.average([set_A_GAU_LVA_c, set_B_GAU_LVA_c, set_C_GAU_LVA_c, set_D_GAU_LVA_c])


""" GAU SVA """

set_A_GAU_SVA_a = np.average(photo_12_SVA_UNdist_grid) / np.average(hand_12_A)
set_B_GAU_SVA_a = np.average(photo_34_SVA_UNdist_grid) / np.average(hand_34_A)
set_C_GAU_SVA_a = np.average(photo_56_SVA_UNdist_grid) / np.average(hand_56_A)
set_D_GAU_SVA_a = np.average(photo_78_SVA_UNdist_grid) / np.average(hand_78_A)

set_ABCD_GAU_SVA_a_avg = np.average([set_A_GAU_SVA_a, set_B_GAU_SVA_a, set_C_GAU_SVA_a, set_D_GAU_SVA_a])


set_A_GAU_SVA_b = np.average(photo_12_SVA_UNdist_grid) / np.average(hand_12_B)
set_B_GAU_SVA_b = np.average(photo_34_SVA_UNdist_grid) / np.average(hand_34_B)
set_C_GAU_SVA_b = np.average(photo_56_SVA_UNdist_grid) / np.average(hand_56_B)
set_D_GAU_SVA_b = np.average(photo_78_SVA_UNdist_grid) / np.average(hand_78_B)

set_ABCD_GAU_SVA_b_avg = np.average([set_A_GAU_SVA_b, set_B_GAU_SVA_b, set_C_GAU_SVA_b, set_D_GAU_SVA_b])


set_A_GAU_SVA_c = np.average(photo_12_SVA_UNdist_grid) / np.average(hand_12_C)
set_B_GAU_SVA_c = np.average(photo_34_SVA_UNdist_grid) / np.average(hand_34_C)
set_C_GAU_SVA_c = np.average(photo_56_SVA_UNdist_grid) / np.average(hand_56_C)
set_D_GAU_SVA_c = np.average(photo_78_SVA_UNdist_grid) / np.average(hand_78_C)

set_ABCD_GAU_SVA_c_avg = np.average([set_A_GAU_SVA_c, set_B_GAU_SVA_c, set_C_GAU_SVA_c, set_D_GAU_SVA_c])
...
set_A_RAD_LVA_a = np.average(photo_12_LVA_dist_RND) / np.average(hand_12_A)
set_B_RAD_LVA_a = np.average(photo_34_LVA_dist_RND) / np.average(hand_34_A)
set_C_RAD_LVA_a = np.average(photo_56_LVA_dist_RND) / np.average(hand_56_A)
set_D_RAD_LVA_a = np.average(photo_78_LVA_dist_RND) / np.average(hand_78_A)

set_ABCD_RAD_LVA_a_avg = np.average([set_A_RAD_LVA_a, set_B_RAD_LVA_a, set_C_RAD_LVA_a, set_D_RAD_LVA_a])

set_A_RAD_LVA_b = np.average(photo_12_LVA_dist_RND) / np.average(hand_12_B)
set_B_RAD_LVA_b = np.average(photo_34_LVA_dist_RND) / np.average(hand_34_B)
set_C_RAD_LVA_b = np.average(photo_56_LVA_dist_RND) / np.average(hand_56_B)
set_D_RAD_LVA_b = np.average(photo_78_LVA_dist_RND) / np.average(hand_78_B)

set_ABCD_RAD_LVA_b_avg = np.average([set_A_RAD_LVA_b, set_B_RAD_LVA_b, set_C_RAD_LVA_b, set_D_RAD_LVA_b])


set_A_RAD_LVA_c = np.average(photo_12_LVA_dist_RND) / np.average(hand_12_C)
set_B_RAD_LVA_c = np.average(photo_34_LVA_dist_RND) / np.average(hand_34_C)
set_C_RAD_LVA_c = np.average(photo_56_LVA_dist_RND) / np.average(hand_56_C)
set_D_RAD_LVA_c = np.average(photo_78_LVA_dist_RND) / np.average(hand_78_C)

set_ABCD_RAD_LVA_c_avg = np.average([set_A_RAD_LVA_c, set_B_RAD_LVA_c, set_C_RAD_LVA_c, set_D_RAD_LVA_c])


""" RAD SVA """

set_A_RAD_SVA_a = np.average(photo_12_SVA_dist_RND) / np.average(hand_12_A)
set_B_RAD_SVA_a = np.average(photo_34_SVA_dist_RND) / np.average(hand_34_A)
set_C_RAD_SVA_a = np.average(photo_56_SVA_dist_RND) / np.average(hand_56_A)
set_D_RAD_SVA_a = np.average(photo_78_SVA_dist_RND) / np.average(hand_78_A)

set_ABCD_RAD_SVA_a_avg = np.average([set_A_RAD_SVA_a, set_B_RAD_SVA_a, set_C_RAD_SVA_a, set_D_RAD_SVA_a])


set_A_RAD_SVA_b = np.average(photo_12_SVA_dist_RND) / np.average(hand_12_B)
set_B_RAD_SVA_b = np.average(photo_34_SVA_dist_RND) / np.average(hand_34_B)
set_C_RAD_SVA_b = np.average(photo_56_SVA_dist_RND) / np.average(hand_56_B)
set_D_RAD_SVA_b = np.average(photo_78_SVA_dist_RND) / np.average(hand_78_B)

set_ABCD_RAD_SVA_b_avg = np.average([set_A_RAD_SVA_b, set_B_RAD_SVA_b, set_C_RAD_SVA_b, set_D_RAD_SVA_b])


set_A_RAD_SVA_c = np.average(photo_12_SVA_dist_RND) / np.average(hand_12_C)
set_B_RAD_SVA_c = np.average(photo_34_SVA_dist_RND) / np.average(hand_34_C)
set_C_RAD_SVA_c = np.average(photo_56_SVA_dist_RND) / np.average(hand_56_C)
set_D_RAD_SVA_c = np.average(photo_78_SVA_dist_RND) / np.average(hand_78_C)

set_ABCD_RAD_SVA_c_avg = np.average([set_A_RAD_SVA_c, set_B_RAD_SVA_c, set_C_RAD_SVA_c, set_D_RAD_SVA_c])
...
set_A_RAU_LVA_a = np.average(photo_12_LVA_UNdist_RND) / np.average(hand_12_A)
set_B_RAU_LVA_a = np.average(photo_34_LVA_UNdist_RND) / np.average(hand_34_A)
set_C_RAU_LVA_a = np.average(photo_56_LVA_UNdist_RND) / np.average(hand_56_A)
set_D_RAU_LVA_a = np.average(photo_78_LVA_UNdist_RND) / np.average(hand_78_A)

set_ABCD_RAU_LVA_a_avg = np.average([set_A_RAU_LVA_a, set_B_RAU_LVA_a, set_C_RAU_LVA_a, set_D_RAU_LVA_a])

set_A_RAU_LVA_b = np.average(photo_12_LVA_UNdist_RND) / np.average(hand_12_B)
set_B_RAU_LVA_b = np.average(photo_34_LVA_UNdist_RND) / np.average(hand_34_B)
set_C_RAU_LVA_b = np.average(photo_56_LVA_UNdist_RND) / np.average(hand_56_B)
set_D_RAU_LVA_b = np.average(photo_78_LVA_UNdist_RND) / np.average(hand_78_B)

set_ABCD_RAU_LVA_b_avg = np.average([set_A_RAU_LVA_b, set_B_RAU_LVA_b, set_C_RAU_LVA_b, set_D_RAU_LVA_b])


set_A_RAU_LVA_c = np.average(photo_12_LVA_UNdist_RND) / np.average(hand_12_C)
set_B_RAU_LVA_c = np.average(photo_34_LVA_UNdist_RND) / np.average(hand_34_C)
set_C_RAU_LVA_c = np.average(photo_56_LVA_UNdist_RND) / np.average(hand_56_C)
set_D_RAU_LVA_c = np.average(photo_78_LVA_UNdist_RND) / np.average(hand_78_C)

set_ABCD_RAU_LVA_c_avg = np.average([set_A_RAU_LVA_c, set_B_RAU_LVA_c, set_C_RAU_LVA_c, set_D_RAU_LVA_c])


""" RAU SVA """

set_A_RAU_SVA_a = np.average(photo_12_SVA_UNdist_RND) / np.average(hand_12_A)
set_B_RAU_SVA_a = np.average(photo_34_SVA_UNdist_RND) / np.average(hand_34_A)
set_C_RAU_SVA_a = np.average(photo_56_SVA_UNdist_RND) / np.average(hand_56_A)
set_D_RAU_SVA_a = np.average(photo_78_SVA_UNdist_RND) / np.average(hand_78_A)

set_ABCD_RAU_SVA_a_avg = np.average([set_A_RAU_SVA_a, set_B_RAU_SVA_a, set_C_RAU_SVA_a, set_D_RAU_SVA_a])


set_A_RAU_SVA_b = np.average(photo_12_SVA_UNdist_RND) / np.average(hand_12_B)
set_B_RAU_SVA_b = np.average(photo_34_SVA_UNdist_RND) / np.average(hand_34_B)
set_C_RAU_SVA_b = np.average(photo_56_SVA_UNdist_RND) / np.average(hand_56_B)
set_D_RAU_SVA_b = np.average(photo_78_SVA_UNdist_RND) / np.average(hand_78_B)

set_ABCD_RAU_SVA_b_avg = np.average([set_A_RAU_SVA_b, set_B_RAU_SVA_b, set_C_RAU_SVA_b, set_D_RAU_SVA_b])


set_A_RAU_SVA_c = np.average(photo_12_SVA_UNdist_RND) / np.average(hand_12_C)
set_B_RAU_SVA_c = np.average(photo_34_SVA_UNdist_RND) / np.average(hand_34_C)
set_C_RAU_SVA_c = np.average(photo_56_SVA_UNdist_RND) / np.average(hand_56_C)
set_D_RAU_SVA_c = np.average(photo_78_SVA_UNdist_RND) / np.average(hand_78_C)

set_ABCD_RAU_SVA_c_avg = np.average([set_A_RAU_SVA_c, set_B_RAU_SVA_c, set_C_RAU_SVA_c, set_D_RAU_SVA_c])
...
""" Set A """
set_A_all_LVA_a = [set_A_GAD_LVA_a, set_A_GAU_LVA_a, set_A_RAD_LVA_a, set_A_RAU_LVA_a]
set_A_all_LVA_b = [set_A_GAD_LVA_b, set_A_GAU_LVA_b, set_A_RAD_LVA_b, set_A_RAU_LVA_b]
set_A_all_LVA_c = [set_A_GAD_LVA_c, set_A_GAU_LVA_c, set_A_RAD_LVA_c, set_A_RAU_LVA_c]

set_A_all_LVA_abc_avg = [np.average(set_A_all_LVA_a), np.average(set_A_all_LVA_b), np.average(set_A_all_LVA_c)]

set_A_all_SVA_a = [set_A_GAD_SVA_a, set_A_GAU_SVA_a, set_A_RAD_SVA_a, set_A_RAU_SVA_a]
set_A_all_SVA_b = [set_A_GAD_SVA_b, set_A_GAU_SVA_b, set_A_RAD_SVA_b, set_A_RAU_SVA_b]
set_A_all_SVA_c = [set_A_GAD_SVA_c, set_A_GAU_SVA_c, set_A_RAD_SVA_c, set_A_RAU_SVA_c]

set_A_all_SVA_abc_avg = [np.average(set_A_all_SVA_a), np.average(set_A_all_SVA_b), np.average(set_A_all_SVA_c)]

""" Set B """
set_B_all_LVA_a = [set_B_GAD_LVA_a, set_B_GAU_LVA_a, set_B_RAD_LVA_a, set_B_RAU_LVA_a]
set_B_all_LVA_b = [set_B_GAD_LVA_b, set_B_GAU_LVA_b, set_B_RAD_LVA_b, set_B_RAU_LVA_b]
set_B_all_LVA_c = [set_B_GAD_LVA_c, set_B_GAU_LVA_c, set_B_RAD_LVA_c, set_B_RAU_LVA_c]

set_B_all_LVA_abc_avg = [np.average(set_B_all_LVA_a), np.average(set_B_all_LVA_b), np.average(set_B_all_LVA_c)]

set_B_all_SVA_a = [set_B_GAD_SVA_a, set_B_GAU_SVA_a, set_B_RAD_SVA_a, set_B_RAU_SVA_a]
set_B_all_SVA_b = [set_B_GAD_SVA_b, set_B_GAU_SVA_b, set_B_RAD_SVA_b, set_B_RAU_SVA_b]
set_B_all_SVA_c = [set_B_GAD_SVA_c, set_B_GAU_SVA_c, set_B_RAD_SVA_c, set_B_RAU_SVA_c]

set_B_all_SVA_abc_avg = [np.average(set_B_all_SVA_a), np.average(set_B_all_SVA_b), np.average(set_B_all_SVA_c)]

""" Set C """
set_C_all_LVA_a = [set_C_GAD_LVA_a, set_C_GAU_LVA_a, set_C_RAD_LVA_a, set_C_RAU_LVA_a]
set_C_all_LVA_b = [set_C_GAD_LVA_b, set_C_GAU_LVA_b, set_C_RAD_LVA_b, set_C_RAU_LVA_b]
set_C_all_LVA_c = [set_C_GAD_LVA_c, set_C_GAU_LVA_c, set_C_RAD_LVA_c, set_C_RAU_LVA_c]

set_C_all_LVA_abc_avg = [np.average(set_C_all_LVA_a), np.average(set_C_all_LVA_b), np.average(set_C_all_LVA_c)]

set_C_all_SVA_a = [set_C_GAD_SVA_a, set_C_GAU_SVA_a, set_C_RAD_SVA_a, set_C_RAU_SVA_a]
set_C_all_SVA_b = [set_C_GAD_SVA_b, set_C_GAU_SVA_b, set_C_RAD_SVA_b, set_C_RAU_SVA_b]
set_C_all_SVA_c = [set_C_GAD_SVA_c, set_C_GAU_SVA_c, set_C_RAD_SVA_c, set_C_RAU_SVA_c]

set_C_all_SVA_abc_avg = [np.average(set_C_all_SVA_a), np.average(set_C_all_SVA_b), np.average(set_C_all_SVA_c)]


""" Set D """
set_D_all_LVA_a = [set_D_GAD_LVA_a, set_D_GAU_LVA_a, set_D_RAD_LVA_a, set_D_RAU_LVA_a]
set_D_all_LVA_b = [set_D_GAD_LVA_b, set_D_GAU_LVA_b, set_D_RAD_LVA_b, set_D_RAU_LVA_b]
set_D_all_LVA_c = [set_D_GAD_LVA_c, set_D_GAU_LVA_c, set_D_RAD_LVA_c, set_D_RAU_LVA_c]

set_D_all_LVA_abc_avg = [np.average(set_D_all_LVA_a), np.average(set_D_all_LVA_b), np.average(set_D_all_LVA_c)]

set_D_all_SVA_a = [set_D_GAD_SVA_a, set_D_GAU_SVA_a, set_D_RAD_SVA_a, set_D_RAU_SVA_a]
set_D_all_SVA_b = [set_D_GAD_SVA_b, set_D_GAU_SVA_b, set_D_RAD_SVA_b, set_D_RAU_SVA_b]
set_D_all_SVA_c = [set_D_GAD_SVA_c, set_D_GAU_SVA_c, set_D_RAD_SVA_c, set_D_RAU_SVA_c]

set_D_all_SVA_abc_avg = [np.average(set_D_all_SVA_a), np.average(set_D_all_SVA_b), np.average(set_D_all_SVA_c)]

""" Set ABCD """

set_ABCD_all_LVA_abc_avg = set_A_all_LVA_abc_avg, set_B_all_LVA_abc_avg, set_C_all_LVA_abc_avg, set_D_all_LVA_abc_avg

set_ABCD_all_SVA_abc_avg = set_A_all_SVA_abc_avg, set_B_all_SVA_abc_avg, set_C_all_SVA_abc_avg, set_D_all_SVA_abc_avg

set_ABCD_all_LVA_a_overall_avg = np.average([set_ABCD_all_LVA_abc_avg[0][0], set_ABCD_all_LVA_abc_avg[1][0], set_ABCD_all_LVA_abc_avg[2][0], set_ABCD_all_LVA_abc_avg[3][0]])
set_ABCD_all_LVA_b_overall_avg = np.average([set_ABCD_all_LVA_abc_avg[0][1], set_ABCD_all_LVA_abc_avg[1][1], set_ABCD_all_LVA_abc_avg[2][1], set_ABCD_all_LVA_abc_avg[3][1]])
set_ABCD_all_LVA_c_overall_avg = np.average([set_ABCD_all_LVA_abc_avg[0][2], set_ABCD_all_LVA_abc_avg[1][2], set_ABCD_all_LVA_abc_avg[2][2], set_ABCD_all_LVA_abc_avg[3][2]])

set_ABCD_all_SVA_a_overall_avg = np.average([set_ABCD_all_SVA_abc_avg[0][0], set_ABCD_all_SVA_abc_avg[1][0], set_ABCD_all_SVA_abc_avg[2][0], set_ABCD_all_SVA_abc_avg[3][0]])
set_ABCD_all_SVA_b_overall_avg = np.average([set_ABCD_all_SVA_abc_avg[0][1], set_ABCD_all_SVA_abc_avg[1][1], set_ABCD_all_SVA_abc_avg[2][1], set_ABCD_all_SVA_abc_avg[3][1]])
set_ABCD_all_SVA_c_overall_avg = np.average([set_ABCD_all_SVA_abc_avg[0][2], set_ABCD_all_SVA_abc_avg[1][2], set_ABCD_all_SVA_abc_avg[2][2], set_ABCD_all_SVA_abc_avg[3][2]])


""" Correction of Percentiles by average correction factor """

# correction_factor_LVA = set_ABCD_all_LVA_b_overall_avg
# correction_factor_SVA = set_ABCD_all_SVA_c_overall_avg

# print("Average LVA/b and SVA/b ratios of all sample sites is used")

# GAD_LVA_perc_setA = np.divide(GAD_LVA_perc_setA, correction_factor_LVA)
# GAU_LVA_perc_setA = np.divide(GAU_LVA_perc_setA, correction_factor_LVA)
# RAD_LVA_perc_setA = np.divide(RAD_LVA_perc_setA, correction_factor_LVA)
# RAU_LVA_perc_setA = np.divide(RAU_LVA_perc_setA, correction_factor_LVA)

# GAD_LVA_perc_setB = np.divide(GAD_LVA_perc_setB, correction_factor_LVA)
# GAU_LVA_perc_setB = np.divide(GAU_LVA_perc_setB, correction_factor_LVA)
# RAD_LVA_perc_setB = np.divide(RAD_LVA_perc_setB, correction_factor_LVA)
# RAU_LVA_perc_setB = np.divide(RAU_LVA_perc_setB, correction_factor_LVA)

# GAD_LVA_perc_setC = np.divide(GAD_LVA_perc_setC, correction_factor_LVA)
# GAU_LVA_perc_setC = np.divide(GAU_LVA_perc_setC, correction_factor_LVA)
# RAD_LVA_perc_setC = np.divide(RAD_LVA_perc_setC, correction_factor_LVA)
# RAU_LVA_perc_setC = np.divide(RAU_LVA_perc_setC, correction_factor_LVA)

# GAD_LVA_perc_setD = np.divide(GAD_LVA_perc_setD, correction_factor_LVA)
# GAU_LVA_perc_setD = np.divide(GAU_LVA_perc_setD, correction_factor_LVA)
# RAD_LVA_perc_setD = np.divide(RAD_LVA_perc_setD, correction_factor_LVA)
# RAU_LVA_perc_setD = np.divide(RAU_LVA_perc_setD, correction_factor_LVA)

# """ ####################################################################### """

# GAD_SVA_perc_setA = np.divide(GAD_SVA_perc_setA, correction_factor_SVA)
# GAU_SVA_perc_setA = np.divide(GAU_SVA_perc_setA, correction_factor_SVA)
# RAD_SVA_perc_setA = np.divide(RAD_SVA_perc_setA, correction_factor_SVA)
# RAU_SVA_perc_setA = np.divide(RAU_SVA_perc_setA, correction_factor_SVA)

# GAD_SVA_perc_setB = np.divide(GAD_SVA_perc_setB, correction_factor_SVA)
# GAU_SVA_perc_setB = np.divide(GAU_SVA_perc_setB, correction_factor_SVA)
# RAD_SVA_perc_setB = np.divide(RAD_SVA_perc_setB, correction_factor_SVA)
# RAU_SVA_perc_setB = np.divide(RAU_SVA_perc_setB, correction_factor_SVA)

# GAD_SVA_perc_setC = np.divide(GAD_SVA_perc_setC, correction_factor_SVA)
# GAU_SVA_perc_setC = np.divide(GAU_SVA_perc_setC, correction_factor_SVA)
# RAD_SVA_perc_setC = np.divide(RAD_SVA_perc_setC, correction_factor_SVA)
# RAU_SVA_perc_setC = np.divide(RAU_SVA_perc_setC, correction_factor_SVA)

# GAD_SVA_perc_setD = np.divide(GAD_SVA_perc_setD, correction_factor_SVA)
# GAU_SVA_perc_setD = np.divide(GAU_SVA_perc_setD, correction_factor_SVA)
# RAD_SVA_perc_setD = np.divide(RAD_SVA_perc_setD, correction_factor_SVA)
# RAU_SVA_perc_setD = np.divide(RAU_SVA_perc_setD, correction_factor_SVA)


""" Correction of Percentiles by correction factor based on sample sites """

###############################################################################
###############################################################################

# print("INDIVIDUAL LVA/b and SVA/b ratios PER sample site is used")


# GAD_LVA_perc_setA = np.divide(GAD_LVA_perc_setA, set_A_GAD_LVA_b)
# GAU_LVA_perc_setA = np.divide(GAU_LVA_perc_setA, set_A_GAU_LVA_b)
# RAD_LVA_perc_setA = np.divide(RAD_LVA_perc_setA, set_A_RAD_LVA_b)
# RAU_LVA_perc_setA = np.divide(RAU_LVA_perc_setA, set_A_RAU_LVA_b)

# GAD_LVA_perc_setB = np.divide(GAD_LVA_perc_setB, set_B_GAD_LVA_b)
# GAU_LVA_perc_setB = np.divide(GAU_LVA_perc_setB, set_B_GAU_LVA_b)
# RAD_LVA_perc_setB = np.divide(RAD_LVA_perc_setB, set_B_RAD_LVA_b)
# RAU_LVA_perc_setB = np.divide(RAU_LVA_perc_setB, set_B_RAU_LVA_b)

# GAD_LVA_perc_setC = np.divide(GAD_LVA_perc_setC, set_C_GAD_LVA_b)
# GAU_LVA_perc_setC = np.divide(GAU_LVA_perc_setC, set_C_GAU_LVA_b)
# RAD_LVA_perc_setC = np.divide(RAD_LVA_perc_setC, set_C_RAD_LVA_b)
# RAU_LVA_perc_setC = np.divide(RAU_LVA_perc_setC, set_C_RAU_LVA_b)

# GAD_LVA_perc_setD = np.divide(GAD_LVA_perc_setD, set_D_GAD_LVA_b)
# GAU_LVA_perc_setD = np.divide(GAU_LVA_perc_setD, set_D_GAU_LVA_b)
# RAD_LVA_perc_setD = np.divide(RAD_LVA_perc_setD, set_D_RAD_LVA_b)
# RAU_LVA_perc_setD = np.divide(RAU_LVA_perc_setD, set_D_RAU_LVA_b)
...
# GAD_SVA_perc_setA = np.divide(GAD_SVA_perc_setA, set_A_GAD_SVA_c)
# GAU_SVA_perc_setA = np.divide(GAU_SVA_perc_setA, set_A_GAU_SVA_c)
# RAD_SVA_perc_setA = np.divide(RAD_SVA_perc_setA, set_A_RAD_SVA_c)
# RAU_SVA_perc_setA = np.divide(RAU_SVA_perc_setA, set_A_RAU_SVA_c)

# GAD_SVA_perc_setB = np.divide(GAD_SVA_perc_setB, set_B_GAD_SVA_c)
# GAU_SVA_perc_setB = np.divide(GAU_SVA_perc_setB, set_B_GAU_SVA_c)
# RAD_SVA_perc_setB = np.divide(RAD_SVA_perc_setB, set_B_RAD_SVA_c)
# RAU_SVA_perc_setB = np.divide(RAU_SVA_perc_setB, set_B_RAU_SVA_c)

# GAD_SVA_perc_setC = np.divide(GAD_SVA_perc_setC, set_C_GAD_SVA_c)
# GAU_SVA_perc_setC = np.divide(GAU_SVA_perc_setC, set_C_GAU_SVA_c)
# RAD_SVA_perc_setC = np.divide(RAD_SVA_perc_setC, set_C_RAD_SVA_c)
# RAU_SVA_perc_setC = np.divide(RAU_SVA_perc_setC, set_C_RAU_SVA_c)

# GAD_SVA_perc_setD = np.divide(GAD_SVA_perc_setD, set_D_GAD_SVA_c)
# GAU_SVA_perc_setD = np.divide(GAU_SVA_perc_setD, set_D_GAU_SVA_c)
# RAD_SVA_perc_setD = np.divide(RAD_SVA_perc_setD, set_D_RAD_SVA_c)
# RAU_SVA_perc_setD = np.divide(RAU_SVA_perc_setD, set_D_RAU_SVA_c)
