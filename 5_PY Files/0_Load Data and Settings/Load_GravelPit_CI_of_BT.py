...
directory = Dir10K_95
print("")
print("Load_GravelPit_CI_of_BT file:")
print("95 CI in use")
print("")
...
# hand_A_perc_CIlength_setA = np.subtract(hand_A_perc_setA, hand_A_perc_lowerCI_setA), np.add(hand_A_perc_setA, hand_A_perc_upperCI_setA)
