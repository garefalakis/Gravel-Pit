...
# avg_corr_factor = 0.8548192539307561 #### from Call_Plot_Grainshape_AxesRatios_vs1.py
...
### if individual ratios are used:
    
# corr_factor_hand_setA_Ds_b_avg = 0.8464767695712473
# corr_factor_hand_setB_Ds_b_avg = 0.8670242453392554
# corr_factor_hand_setC_Ds_b_avg = 0.8533836002249648
# corr_factor_hand_setD_Ds_b_avg = 0.8523924005875569

# sieve_A_perc_lin = np.divide(sieve_A_perc_lin, corr_factor_hand_setA_Ds_b_avg)
# sieve_B_perc_lin = np.divide(sieve_B_perc_lin, corr_factor_hand_setB_Ds_b_avg)
# sieve_C_perc_lin = np.divide(sieve_C_perc_lin, corr_factor_hand_setC_Ds_b_avg)
# sieve_D_perc_lin = np.divide(sieve_D_perc_lin, corr_factor_hand_setD_Ds_b_avg)
...
# correction_factor_LVA = 0.8292061640411508 ### i.e. from Load_GravelPitData --> set_ABCD_all_LVA_b_overall_avg
# correction_factor_SVA = 0.7612176992807024 ### i.e. from Load_GravelPitData --> set_ABCD_all_SVA_c_overall_avg
