...
def subplot_photo_data_vs_discharge_direction(data1, data2, data1_SD, data2_SD,
    ...
    site_label = ['Set A vs B ($LVA$', 'Set A vs B ($SVA$)', 'Set C vs D ($SVA$)', 'Set C vs D ($SVA$)']
    ...
    """ ### Plot 1 ### """
    ####### Arrange x, y ticks   
    ceil_axis, line_max = ceil_xyaxis_noarray(data1[setnumber], data1_SD[setnumber], data2[setnumber], data2_SD[setnumber])
    ...
    ### Plot original data (i.e. percentiles) with errorbar:
        axs[setnumber].errorbar(data2[i], data1[i], yerr=data1_SD[i], xerr=data2_SD[i],
    ...
    """ ### Plot 2 ### """
    ####### Arrange x, y ticks   
    ceil_axis, line_max = ceil_xyaxis_noarray(data3[setnumber], data3_SD[setnumber], data4[setnumber], data4_SD[setnumber])
    ...
    ### Plot original data (i.e. percentiles) with errorbar:
        axs[setnumber].errorbar(data4[i], data3[i], yerr=data4_SD[i], xerr=data3_SD[i],
                      ls='', elinewidth=0.7, capsize=1.5, capthick=0.4, ms=1.5,
    ...
    """ ### Plot 3 ### """
    ####### Arrange x, y ticks   
    ceil_axis, line_max = ceil_xyaxis_noarray(data5[setnumber], data5_SD[setnumber], data6[setnumber], data6_SD[setnumber])
    ...
    ### Plot original data (i.e. percentiles) with errorbar:
        axs[setnumber].errorbar(data6[i], data5[i], yerr=data5_SD[i], xerr=data6_SD[i],
                      ls='', elinewidth=0.7, capsize=1.5, capthick=0.4, ms=1.5,
                      color=colors_LVA[i], fmt='.', label=dot_label[i])
    ...
    """ ### Plot 4 ### """
    ####### Arrange x, y ticks   
    ceil_axis, line_max = ceil_xyaxis_noarray(data7[setnumber], data7_SD[setnumber], data8[setnumber], data8_SD[setnumber])
    ...
    for i in range(len(data5)):        
    ### Plot original data (i.e. percentiles) with errorbar:
        axs[setnumber].errorbar(data8[i], data7[i], yerr=data7_SD[i], xerr=data8_SD[i],
                      ls='', elinewidth=0.7, capsize=1.5, capthick=0.4, ms=1.5,
                      color=colors_SVA[i], fmt='.', label=dot_label[i])
...
test = subplot_photo_data_vs_discharge_direction(setA_LVA_perc, setB_LVA_perc, setA_LVA_perc_SD, setB_LVA_perc_SD,
                                                 setA_SVA_perc, setB_SVA_perc, setA_SVA_perc_SD, setB_SVA_perc_SD,
                                                 setC_LVA_perc, setD_LVA_perc, setC_LVA_perc_SD, setD_LVA_perc_SD,
                                                 setC_SVA_perc, setD_SVA_perc, setC_SVA_perc_SD, setD_SVA_perc_SD,
